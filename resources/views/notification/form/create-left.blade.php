    ...
    <div class="row">
        ...
        <div class="col-md-12 col-12">
            <div class="card">
                ...
                <div class="card-body p-2">
                    <input class="form-control " name="title" :value="old('title')"  placeholder="Tiêu Đề"/>
                </div>
            </div>
        </div>
        <!-- desc -->
        <div class="col-md-12 col-12 mt-2">
            <div class="card">
                ...
                <div class="card-body p-2">
                    <textarea id="editor1" name="desc" class="form-control w-100" style="height: 30vh;" id="descriptionInput" rows="3"></textarea>
                </div>
            </div>
        </div>
    </div>
