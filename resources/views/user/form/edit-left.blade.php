    ...
    <div class="row">
        ...
        <div class="col-12 mt-2">
            <div class="card">
                ...
                <div class="card-body p-2">
                    <input type="text" class="form-control" name="name" value="{{$data->name}}" placeholder="Họ và Tên" />
                </div>
            </div>
        </div>
        <!-- Email -->
        ...
        <div class="col-12 mt-2">
            <div class="card">
                ...
                <div class="card-body p-2">
                    <input type="text" class="form-control" name="phone" value="{{$data->phone}}" placeholder="Số Điện Thoại" required />
                </div>
            </div>
        </div>
        <!-- Gender & Roles -->
